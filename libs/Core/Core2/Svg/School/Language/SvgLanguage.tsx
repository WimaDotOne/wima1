...
export function SvgLanguage({
  width,
  fill
}: ISvg) {

  return(<>
    <Svg viewBox="1 0 32 31" width={width} fill={fill}>
      ...
      <path d="M20,17c1.1,0,2.6-0.3,4-1c1.4,0.7,3,1,4,1v-2c0,0-1,0-2.1-0.4c1.2-1.2,2.1-3,2.1-5.6V8h-3V6h-2v2h-3v2h5.9
